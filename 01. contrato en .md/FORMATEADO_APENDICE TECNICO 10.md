...
**Capacidad Disponible de la Vía Férrea y Preasignación de Surcos**
...
REPÚBLICA DE COLOivlBIA 1v1INISTERIO DE TRANSPORTE
...
2 .1. La medición de Capacidad Ferroviaria estará a cargo y bajo la responsabilidad del Concesionario, el cual deberá realizar los cálculos a través de un procedimiento y método de simulación que sea diseñado a la medida de la Infraestructura, con el fin de hacer asignaciones de Surcos de Movilización de forma correcta, eficiente y segura. El procedimiento y método de simulación y los cálculos de la Capacidad Ferroviaria serán presentados a la Interventoría, a la ANI y/o a quien para tal efecto designe la ANI para su análisis y posterior no objeción, de conformidad con lo dispuesto en el numeral 2.5 y siguientes de este Apéndice Técnico.
...
(x) Los servicios de transporte ferroviario prestados (carga, pasajeros y/o mixto);
...
Capacidad Disponible de la Vía Férrea\\s+Capacidad Ferroviaria - Capacidad Asignada C_{disponible} = C_{ferroviaria} - C_{asignada} Capacidad Disponible de la Vía Férrea\\s+Capacidad Ferroviaria - Capacidad Asignada C_{disponible} = C_{ferroviaria} - C_{asignada} ### Fórmula de Capacidad:

Capacidad Disponible de la Vía Férrea\\s+Capacidad Ferroviaria - Capacidad Asignada C_{disponible} = C_{ferroviaria} - C_{asignada} Capacidad Disponible de la Vía Férrea\\s+Capacidad Ferroviaria - Capacidad Asignada

La Capacidad Asignada podrá estar ocupada por:

(a) Trenes comerciales (de carga y/o de pasajero, según el contexto);
(b) Trenes vacíos (de carga y/o de pasajero, según el contexto);
...
(c) Los Surcos de Movilización disponibles y/o solicitados por el Tercero Interesado.
...
(c) La documentación actualizada y características técnicas de la Infraestructura Ferroviaria a ser utilizada con sus correspondientes estándares técnicos y/o normas técnicas específicas para su adecuada verificación.
...
4.6. Por otra parte, el Concesionario tendrá como obligación actualizar el documento cuando existan cambios por parte de la Operación o por solicitudes directas de la Interventoría y/o laANI.

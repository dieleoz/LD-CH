const wbsMetadata = {
  ...
  "items": {
    "1.1.100": {
      ...
      "justificacion_tecnica": "Fundamentado en AT1 (Control de Tráfico), que define la arquitectura tecnológica para el control centralizado del tráfico ferroviario. AT2 (Operación y Mantenimiento) exige disponibilidad garantizada 24/7 y AT3 (Especificaciones Generales) impone redundancia activa para sistemas vitales. La configuración mínima es 2 UND (1 servidor principal + 1 servidor respaldo en hot-standby) para asegurar failover inmediato y cumplimiento contractual con integración ETCS L2/FENOCO.",
      "criterios_diseno": [
      ...
      "supuestos": [
        ...
        "Arquitectura cliente-servidor virtualizada con cluster activo",
        "Comunicación redundante sobre fibra óptica en doble anillo",
        "Monitoreo continuo 24/7 conforme a plan de O&M (AT2)"
      ],
      "decisiones_tecnicas": [
        "DT-CTC-004-2025-10-24",
        "DT-FIBRA-011-2025-11-06"
      ],
      "feedback_especialista": "Servidores configurados según arquitectura CTC virtual con redundancia activa, compatibles con ATP embarcado, enclavamientos ENCE y protocolos FENOCO.",
    ...
    "1.1.103": {
      ...
      "justificacion_tecnica": "Fundamentado en AT1 (Control de Tráfico) que define la arquitectura funcional del CTC virtual y su interoperabilidad con ETCS Level 2. AT3 (Especificaciones Generales) y AT4 (Disponibilidad) exigen operación 24/7, tolerancia a fallos y compatibilidad con los protocolos FENOCO. Se mantiene 1 UND de licencia enterprise para plataforma CTC/ETCS L2 con redundancia lógica activa-activa y conectores de interoperabilidad FENOCO para garantizar continuidad del servicio.",
      "criterios_diseno": [
        "Plataforma virtualizada con cluster redundante activo-activo",
        "Compatibilidad ETCS Level 2 y PTC según AT1/AT3",
        "Integración API con RBC FENOCO y módulos CTC",
        "Monitoreo 24/7 con actualizaciones en caliente y RTO<1h"
      ],
      "supuestos": [
        "Licenciamiento corporativo con soporte 24/7",
        "Canal redundante con replicación en sitio alterno",
        "Interfaces dedicadas para intercambio de órdenes con FENOCO",
        "Capacitación integral de operadores y administradores (AT2)",
        "Cumplimiento CENELEC EN 50126/128/129 para software vital"
      ],
      "decisiones_tecnicas": [
      ...
      "ultima_actualizacion": "2025-11-11",
      "actualizado_por": "DT-FIBRA-160-2025-11-06"
    },
    "5.3.100": {
  ...
  "1.3.100": {
    ...
    "criterios_diseno": [
      ...
      "Interfaces bidireccionales con CTC central y ETCS L2",
      "Diagnóstico y telemetría 24/7 para mantenimiento predictivo"
    ],
    "supuestos": [
      "Controlador incluye gabinete redundante ENCE completo",
      "Sincronización permanente con red fibra óptica y TETRA",
      "Protección EMC y alimentación respaldada UPS/rectificadores",
      "Migración sin interrupción coordinada con FENOCO"
    ],
    "decisiones_tecnicas": [
      "DT-ENCE-003-2025-10-07",
      "DT-FIBRA-797-2025-11-06"
    ],
    "feedback_especialista": "Enclavamiento (ENCE) debe tener redundancia; gobierna señales y agujas y debe operar en modo fail-safe ante eventos de fallo.",
    "documentos_ingenieria": [
      "V.X_Enclavamientos_ENCE_Detalle_v5.0.md",
      "29_Sistema_Senalizacion_Integrado_v5.0.md",
    ...
    "ultima_actualizacion": "2025-11-11",
    "actualizado_por": "DT-FIBRA-797-2025-11-06"
  },
  "1.3.101": {
    ...
    "ultima_actualizacion": "2025-11-11",
    "actualizado_por": "DT-FIBRA-318-2025-11-07"
  },
  "1.3.102": {
    ...
    "ultima_actualizacion": "2025-11-11",
    "actualizado_por": "DT-FIBRA-522-2025-11-07"
  },
  "1.3.103": {
    ...
    "ultima_actualizacion": "2025-11-11",
    "actualizado_por": "DT-FIBRA-384-2025-11-07"
  },
  "1.3.104": {
    ...
    "ultima_actualizacion": "2025-11-11",
    "actualizado_por": "DT-FIBRA-301-2025-11-07"
  },
  "2.1.100": {

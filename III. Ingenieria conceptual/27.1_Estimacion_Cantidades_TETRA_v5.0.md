# ESTIMACIÓN DE CANTIDADES TETRA v7.0 - PHASE 7
**Versión:** 7.0 (Phase 7)  
**Fecha:** Febrero 2026  
...
2. **V.3_Sistemas_Comunicacion_Detalle.md** - TETRA agregado
...
#### **4.2.2 Sistema TETRA (37 Estaciones) - NUEVO**
**Funcionalidades:**
...
#### **7.1.3 Sistema TETRA (37 Estaciones) - NUEVO**
**Estaciones Base TETRA**
- 37 Estaciones base TETRA (colocalizadas con TETRA)
- 3 Estaciones base redundantes (backup crítico)
- 2 Estaciones base CCO (principal + respaldo)
- **ESTIMACIÓN:** **42 Equipos Estación Base TETRA**

**Radios TETRA Embarcados**
- Radios TETRA embarcados locomotoras: 15 unidades
- Radios TETRA portátiles mantenimiento: 30 unidades
- Radios TETRA vehículos de inspección: 15 unidades
- **ESTIMACIÓN:** **60 Equipos de Radio TETRA**

#### **7.1.4 Consumo Eléctrico TETRA + TETRA**
**Por Estación Base**
- Potencia estación base TETRA: 500W
- Potencia estación base TETRA: 300W
...
- Potencia instalada requerida: 185 kW
- **ESTIMACIÓN:** **185 kW Total + UPS + Generadores**
...
|:--------|:--------------|:------------|:----------|
| **TETRA + TETRA** | 199 | 4 horas | Requerido |
...
- Estaciones TETRA + TETRA: 37 × 6 kVA = 222 kVA UPS  
...
- Total predial TETRA + TETRA: 111,000 m² (11.1 hectáreas)
...
**TETRA + TETRA (ANE - Agencia Nacional Espectro)**
...
| **Torres TETRA + TETRA** | Meses 20-32 | Permisos ANE |
| **Tendido fibra** | Meses 28-34 | Ductos terminados |
| **Equipos TETRA + TETRA** | Meses 30-36 | Torres listas |
| **Pruebas integración** | Meses 34-36 | Todos los sistemas |

#### **7.5.2 Ruta Crítica**
**GESTIÓN PREDIAL → PERMISOS → DUCTOS → FIBRA → INTEGRACIÓN**
(El TETRA + TETRA puede ir en paralelo una vez liberados predios)
...
| **Estaciones Base TETRA** | 42 | 120,000 | 5,040,000 |
...
- Mantenimiento TETRA + TETRA: USD 800,000/año
...
1. Estudio propagación radio (TETRA + TETRA): Drive test 526.133 km
2. Estudio geotécnico: fundaciones torres + casetas
3. Análisis interferencias: EMC entre TETRA, TETRA y fibra
...
2. Sites alternativos TETRA + TETRA (problemas prediales)
...
- **Responsable:** Administrador Contractual EPC
- **Impacto presupuestal:** +$15,114,000,000 COP (TETRA + TETRA + Fibra)

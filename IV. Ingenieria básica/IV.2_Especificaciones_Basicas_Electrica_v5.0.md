...
## 7. ESPECIFICACIONES DE SISTEMAS ELÉCTRICOS
...
|:---------|:---------------|:-----------|:---------------|
| **Voltaje Principal** | 480V/60Hz ±5% | Todos los sistemas | RETIE, NTC 2050 |
| **Voltaje Secundario** | 24V DC ±10% | Señalización, Material Rodante | RETIE, NTC 2050 |
| **UPS N+1** | Redundancia total | Sistemas críticos (CTC, ENCE) | RETIE, NTC 2050 |
...
## 15. RECOMENDACIONES PARA GESTIÓN DE RIESGOS

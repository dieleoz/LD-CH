...
| **Número** | 39 |
| **Estado** | ⚠️ **INGENIERÍA BÁSICA EN SANEAMIENTO (RE-LINEACIÓN APC)** |
...
### 5.1 Estrategia de Localización Radio (Conceptual)

#### **🏗️ Criterios de Ubicación de Nodos**
Se proponen zonas de ubicación basadas en la topografía del corredor, las cuales deberán ser validadas mediante:
1. **Estudio de Propagación:** Determinará la cantidad real de sitios (estimada entre 30-40).
2. **Disponibilidad Predial (AT7):** Los sitios definitivos dependerán de la factibilidad de adquisición de terrenos.
3. **Restricciones Ambientales (AT6):** Verificación de exclusión de áreas protegidas.

| Zona Operativa | Función Proyectada | Justificación Técnica |
|:---------------|:-------------------|:----------------------|
| **Chiriguaná** | Nodo Terminal Norte | Interfaz con red FENOCO |
| **Zapatosa** | Nodo Intermedio | Cruce ramal Capulco |
| **San Alberto** | Nodo Intermedio | Cobertura corredor |
| **Puerto Triunfo** | Nodo Intermedio | Centro de gravedad corredor |
| **La Dorada** | Nodo Terminal Sur | Interfaz con CCO proyectado |
...
## 🔄 **ACTUALIZACIÓN - RE-LINEACIÓN APC**
Se eliminan las coordenadas GPS y etiquetas de sitios fijos, re-clasificándolos como nodos conceptuales sujetos a estudios de campo.

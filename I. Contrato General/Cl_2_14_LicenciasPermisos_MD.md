...
**Cláusula:** 3.11(l) / 2.141 - Gestión de Licencias y Permisos  
...
| **v4.0** | Oct-2025 | Ing. Contractual | Corrección crítica de referencias (3.11(l) y 2.141) |
...
> **📖 Contrato General - Sección 3.11(l):**
> 
> "Tramitar y obtener, bajo su propia responsabilidad, ante las Autoridades Estatales y/o Autoridades Ambientales todas las Licencias y Permisos que considere necesarios para adelantar el Proyecto, para el uso y aprovechamiento de recursos naturales en cumplimiento de la normativa ambiental aplicable..." *(Texto sujeto a validación final con Contrato Principal)*
>
> **📖 Contrato General - Definición 2.141:**
>
> "Son los permisos, concesiones, autorizaciones y/o licencias que deban ser otorgados por cualquier Autoridad Estatal, necesarios para la ejecución del Proyecto por parte del Concesionario cuyo trámite y costo estará a cargo del Concesionario, por su cuenta y riesgo." *(Texto sujeto a validación final con Contrato Principal)*

### **1.2 Normativa y Documentos Aplicables**

#### **📋 Contrato General:**
- **Sección 3.11(l):** Obligación transversal de gestión de licencias
- **Definición 2.141:** Definición de Licencias y Permisos
- **Sección 2.52:** Definición de Compensaciones Socioambientales
- **Sección 3.12:** Obligaciones Transversales de la ANI (Participación como tercero)
...
> **📋 RESPONSABILIDADES:**
> 
> - **🔴 Frecuencias TETRA:** Para comunicaciones operacionales (Requisito para operatividad del Sistema TETRA - AT1 Tabla 17)
...
>
> **⚠️ NOTA:** La ausencia de estos permisos afecta el Indicador COM1 (Disponibilidad de Comunicaciones) del AT4, impactando directamente la Retribución Mensual.
...
> |:---:|:---|:---|:---|
> | **3** | Radicación solicitud frecuencias TETRA *(Hito Plan de Obras)* | Coordinador Técnico | Solicitud formal ANE |
...
#### **🏛️ Actividad 3.2.3: Permisos Municipales y Prediales**
> **🗓️ CRONOGRAMA:**
> 
> | **Mes** | **Actividad** | **Responsable** | **Entregable** |
> |:---:|:---|:---|:---|
...
#### **🔴 Conflictos Prediales No Resueltos:**
> **📊 ANÁLISIS DE RIESGO:**
> 
...
> - **📋 Contractual:** Responsabilidad EPC según Sección 3.11(l)
...
### **📋 6.1 Obligaciones de Gestión (Sección 3.11(l))**
...
|:---|:---|:---|:---|
| **Retraso obtención permisos críticos** | Según AT4 y Sec. 16.6 | Valor UFVF afectada | Automática |
| **No obtención permiso ANE** | Según AT4 y Sec. 16.6 | Valor sistemas comunicaciones | Por evaluación |
| **Incumplimiento ambiental** | Según Sec. 16.6 | Valor total contrato | Por evento |
| **Conflicto predial no resuelto** | Según AT4 y Sec. 16.6 | Valor obras bloqueadas | Automática |

### **📊 7.2 Criterios de Aplicación**
...
> - **🌱 Compensaciones socioambientales:** Gestión integrada según Sección 2.52 y AT6
...
> **📝 La gestión exitosa de licencias y permisos según Sección 3.11(l) es fundamental para la viabilidad técnica y legal del Proyecto APP La Dorada–Chiriguaná.**
...
### **🎯 Resultado Esperado:**
> **📝 El cumplimiento de la Sección 3.11(l) garantiza que el EPC tenga todas las autorizaciones necesarias para ejecutar el proyecto dentro de los plazos contractuales, minimizando riesgos de penalidades y asegurando la continuidad operativa.**

### **⚠️ ADVERTENCIA DE GESTIÓN PARALELA**
> **La Cesión de Licencias Ambientales (LAM6817/LAM3365) es una Condición Precedente crítica para el inicio de obras según AT6 Sección 5.7. Esta gestión debe ser prioritaria y ruta crítica absoluta.**
...
He realizado la validación forense comparativa contrastándolo con el Contrato (PDF) y Apéndice Técnico 6.
**Conclusión:** Documento impecable que cubre vacíos operativos peligrosos. Refleja fielmente la transferencia total del riesgo y añade la capa tecnológica (ANE) crítica.

### 🛡️ 1. VALIDACIÓN DEL RIESGO LEGAL (LA REGLA DE ORO)
El documento interpreta correctamente la asignación de riesgos:
*   **Definición de Responsabilidad:** Definición 2.141 establece: "...cuyo trámite y costo estará a cargo del Concesionario, por su cuenta y riesgo".
*   **Veredicto:** **CORRECTO**. No existe "permiso compartido". Si la ANLA se demora, el EPC asume el impacto (salvo fuerza mayor).

### 🌱 2. GESTIÓN AMBIENTAL (EL PASIVO OCULTO)
Identificación correcta de expedientes a ceder (Anexo AT6):
*   **Expedientes:** Resolución 0751 de 2002 (**LAM6817**) y Resolución 2098 de 2005 (**LAM3365**).
*   **Alerta Crítica:** El contrato obliga a recibir estas licencias con sus obligaciones y procesos sancionatorios pendientes. Es ruta crítica; sin cesión, no hay inicio de obra.

### 📡 3. LA BRECHA TECNOLÓGICA (VALOR AGREGADO MD)
El MD supera al PDF al detallar requisitos implícitos por Ley 1341:
*   **Permisos ANE:** El contrato exige TETRA (AT3), pero para operarlo es obligatorio obtener el espectro. Sin permiso ANE, las 37 torres son inútiles legalmente.

### 🚀 4. INSTRUCCIONES REFORZADAS AL EQUIPO
1.  **Prioridad 1 (Cesión):** Radicar solicitud de cesión **LAM6817/LAM3365** en Mes 1.
2.  **Permisos ANE:** Iniciar trámite frecuencial para TETRA inmediatamente. Retraso aquí es multa segura por indisponibilidad.
3.  **Auditoría Multas Heredadas:** Verificar estado de procesos sancionatorios previos en LAM6817 para deslindar responsabilidad (ANI vs EPC).

### ✅ VEREDICTO FINAL
**Estado:** **APROBADO PARA USO**. Guía de ejecución validada.
**Advertencia:** Asumir gestión de permisos municipales para torres (Licencias Construcción) aunque sea proyecto nacional, para evitar conflictos locales.

⚠️ **ADVERTENCIA LEGAL:** La entrega de estudios previos o licencias existentes **NO** exime al Concesionario de obtener permisos adicionales. La cláusula de "Cuenta y Riesgo" es absoluta.

...
|:---|:---|:---|:---|
| **Retraso obtención permisos críticos** | 0.1% diario *(Pendiente validación)* | Valor UFVF afectada | Automática |
| **No obtención permiso ANE** | 5% *(Pendiente validación)* | Valor sistemas comunicaciones | Por evaluación |

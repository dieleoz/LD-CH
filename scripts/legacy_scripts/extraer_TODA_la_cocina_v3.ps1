# EXTRACTOR TODA LA COCINA - Completo (Version 3)
...
Write-Host "  Conceptual: $conceptualPath" -ForegroundColor White
Write-Host "  Basica: $basicaPath" -ForegroundColor White
...
Write-Host "  OK: Ambos directorios encontrados" -ForegroundColor Green
